...
public class LoginActivityTest6_1 {
    private String incorrectEmail="ghost@gmail.com";
    private String inpasseword="ghost1234";
    ...
    public void testActivity(){
        ...
        onView(withId(R.id.tv_password)).perform(typeText(inpasseword));
